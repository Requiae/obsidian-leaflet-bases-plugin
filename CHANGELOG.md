...
- Map context menu: Right click a position on the map to add a marker or update the map. ([#17](https://github.com/Requiae/obsidian-leaflet-bases-plugin/pull/17))
- Marker context menu: Right click a marker to update or remove a marker. ([#17](https://github.com/Requiae/obsidian-leaflet-bases-plugin/pull/17))
- Removed the map "copy tool" and added the lost functionality to the map and marker context menus ([#17](https://github.com/Requiae/obsidian-leaflet-bases-plugin/pull/17))
...
- The note-picker modal now crashes gracefully when obsidian is unable to deserialise the user's base formula ([#23](https://github.com/Requiae/obsidian-leaflet-bases-plugin/pull/23))
